...
def transformEvent(event, metadata):
  return {
    ...
    "city": getCity(event.get('context', {}).get('traits', {}).get('address', {})),
    "country": getCountry(event.get('context', {}).get('traits', {}).get('address', {})),
    "street": getStreet(event.get('context', {}).get('traits', {}).get('address', {})),
  }